<!--
 * @Date: 2021-12-24 19:36:44
 * @LastEditTime: 2021-12-24 20:27:44
 * @FilePath: \imooc-blog\components\search-result-item-theme-2\search-result-item-theme-2.vue
-->
<template>
...
<script>
export default {
  name: "search-result-item-theme-2",
  props: {
    data: {
      type: Object,
      required: true,
